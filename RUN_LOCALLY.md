# 💻 Running HackTheBox Walkthroughs Locally
...
👉 **[http://localhost:4321/HackTheBox/](http://localhost:4321/HackTheBox/)**
...
| Command | Description |
| :--- | :--- |
| `npm run dev` | Starts the local dev server at `http://localhost:4321/HackTheBox/` |
